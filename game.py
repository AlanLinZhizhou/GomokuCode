...
class Gomoku:
            ...
            try:
                ...
                if 0 <= pos_x <= 14 and 0 <= pos_y <= 14:  # 判断这个格子能否落子
                    if self.g_map[pos_x][pos_y] == 0:
                        self.g_map[pos_x][pos_y] = self.dict['1']
                        print('玩家下的',self.dict['1'])
                        self.cur_step += 1
                        return
    ...
    def ai_play_1step_by_cpp(self):
        ...
        self.g_map[ai_ope[0]][ai_ope[1]] = self.dict['2']
        self.cur_step += 1
    ...
    def ai_play_1step_py_python(self):
        ...
        self.g_map[ai_ope[0]][ai_ope[1]] = self.dict['2']
        print('ai ','x:',ai_ope[0],'y',ai_ope[1])
        self.lastx=ai_ope[0]
        self.lasty=ai_ope[1]
        self.cur_step += 1
